<footer>
    <div class="custom-shape-divider-top-1717008705">
    ...
    <div class="footer-container">
        <div class="footer-column">
            ...
            <ul class="list-unstyled">
                ...
                <li><a href="<?php echo $basePath; ?>/pages/about.php">The Team</a></li>
            </ul>
        </div>
        <div class="footer-column">
            <h1>Follow Us</h1>
            <div class="social-icons">
                ...
                <a href="https://www.instagram.com/thedomaindesigners/"><img src="<?php echo $basePath; ?>/assets/icons/instagram.svg" width="20" height="20" alt="Instagram Icon"></a>
            </div>
        </div>
        <div class="footer-column">
            <h1>Contact Us</h1>
    ...
    <div class="footer-bottom">
        <p>&copy; 2024 TheDomainDesigners. All rights reserved.</p>
    </div>
</footer>