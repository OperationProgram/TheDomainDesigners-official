  ...
  <section class="hero-section">
    <div class="hero-content">
        ...
        <div class="cta">
            ...
            <a href="../contact.php"><button class="cta-button">Contact Us</button><a href="../contact.php">
        </div>
...
"Background image featuring a calculator, magnifying glass, and chart - Quick Links for WordPress Site Builder Services" src="../../assets/information.jpg" />
  ...
  <img class="sr-only" alt="People analyzing a pie chart - Design & Customization Services by The Domain Designers" src="../../assets/planning.jpg" />
    <div class="sub-cta">
      ...
      <div class="cta-column">
        <h2 class="custom-h2" data-aos="fade-up" data-aos-duration="1300">Planning For Success</h2>
        <h1 class="custom-h1" data-aos="fade-up" data-aos-duration="1300">Design & Customization</h1>
  ...
  <section id="section-2-header" class="section-1">
    <div class="sub-cta">
      <div class="cta-column">
        <h2 class="custom-h2" data-aos="fade-up" data-aos-duration="1300">Make It Easy</h2>
        <h1 class="custom-h1" data-aos="fade-up" data-aos-duration="1300">Plugins</h1>
  ...
  <section id="section-3-header" class="section-3">
    ...
    <div id="ps-left-column" class="text-column">
      ...
      <ul>
        <li data-aos="fade-up" data-aos-duration="1300"><p> <strong class="custom-bold">Hello by Elementor</strong><br/>
  ...
  <section id="section-5-header" class="section-5">
    <div class="sub-cta">
      <div class="cta-column">
        <h2 class="custom-h2" data-aos="fade-up" data-aos-duration="1300">Manageability made Easy</h2>
        <h1 class="custom-h1" data-aos="fade-up" data-aos-duration="1300">Page Builders</h1>
        <p data-aos="fade-up" data-aos-duration="1300"> 
