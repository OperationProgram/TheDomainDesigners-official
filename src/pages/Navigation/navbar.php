<a class="logo-link" href="<?php echo $basePath; ?>/"><img class="logo" src="<?php echo $basePath; ?>/assets/tdd_logo.svg" alt="The Domain Designers Logo" width="100" height="100"></a>
<nav class="navbar">
